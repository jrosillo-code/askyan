...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Application flow (Request Access)
    "app.page.lede": "The first journeys will be small, slow, and unrepeatable. Tell us who you are — a founder reads every application.",
    "app.page.general": "Press, partnerships or something else →",
    "app.page.hideGeneral": "Hide general inquiries",
    "app.step1": "Who you are",
    "app.step2": "Which journey calls",
    "app.step3": "Why you",
    "app.name.placeholder": "Full name",
    "app.email.placeholder": "Email",
    "app.why.placeholder": "What draws you to the unseen world? A few honest sentences beat a polished paragraph.",
    "app.referral.placeholder": "How did you hear about ASKYAN? (optional)",
    "app.undecided": "Undecided — advise me",
    "app.undecided.country": "The Unseen World",
    "app.open": "OPEN",
    "app.expedition": "EXPEDITION",
    "app.back": "Back",
    "app.continue": "Continue",
    "app.submit": "Submit application",
    "app.sending": "Sending…",
    "app.err.name": "Your name, at least.",
    "app.err.email": "A real email — it's how we reply.",
    "app.err.expedition": "Choose a journey — or 'Undecided'.",
    "app.err.why": "A sentence or two — why this, why now.",
    "app.err.generic": "Something went wrong — try again.",
    "app.pass.received": "Application received",
    "app.pass.cohort": "FOUNDING COHORT",
    "app.pass.applicant": "APPLICANT",
    "app.pass.status": "STATUS",
    "app.pass.review": "Under review",
    "app.pass.expedition": "EXPEDITION",
    "app.pass.anchor": "ANCHOR",
  ...
  es: {
    ...
    // Application flow (Request Access)
    "app.page.lede": "Los primeros viajes serán pequeños, lentos e irrepetibles. Cuéntanos quién eres — un fundador lee cada solicitud.",
    "app.page.general": "Prensa, alianzas u otra cosa →",
    "app.page.hideGeneral": "Ocultar consultas generales",
    "app.step1": "Quién eres",
    "app.step2": "Qué viaje te llama",
    "app.step3": "Por qué tú",
    "app.name.placeholder": "Nombre completo",
    "app.email.placeholder": "Correo electrónico",
    "app.why.placeholder": "¿Qué te atrae del mundo no visto? Unas frases honestas valen más que un párrafo pulido.",
    "app.referral.placeholder": "¿Cómo conociste ASKYAN? (opcional)",
    "app.undecided": "Indeciso — aconséjenme",
    "app.undecided.country": "El Mundo No Visto",
    "app.open": "ABIERTO",
    "app.expedition": "EXPEDICIÓN",
    "app.back": "Atrás",
    "app.continue": "Continuar",
    "app.submit": "Enviar solicitud",
    "app.sending": "Enviando…",
    "app.err.name": "Tu nombre, al menos.",
    "app.err.email": "Un correo real — es como respondemos.",
    "app.err.expedition": "Elige un viaje — o 'Indeciso'.",
    "app.err.why": "Una o dos frases — por qué esto, por qué ahora.",
    "app.err.generic": "Algo salió mal — inténtalo de nuevo.",
    "app.pass.received": "Solicitud recibida",
    "app.pass.cohort": "COHORTE FUNDADORA",
    "app.pass.applicant": "SOLICITANTE",
    "app.pass.status": "ESTADO",
    "app.pass.review": "En revisión",
    "app.pass.expedition": "EXPEDICIÓN",
    "app.pass.anchor": "ANCLA",
